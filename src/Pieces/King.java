...
public class King extends Piece{
    ...
    public ArrayList<Spot> getPossibleMoves(Spot board[][], int x, int y){
        ...
        if (ChessGUI.getCurrentMove().equals(this.getPieceColor())){
            ...
            //Short Castle
            if(this.getMoveCounter() == 0 && board[x][y + 1].getPiece() == null && board[x][y + 2].getPiece() == null && !isInCheck(board)){
            ...
            //Long Castle
            if(this.getMoveCounter() == 0 && board[x][y - 1].getPiece() == null && board[x][y - 2].getPiece() == null && board[x][y - 3].getPiece() == null && !isInCheck(board)){
